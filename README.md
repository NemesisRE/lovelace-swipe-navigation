...
1. Copy [swipe-navigation.js](https://github.com/NemesisRE/lovelace-swipe-navigation/releases/latest) from the latest release into `/www/lovelace-swipe-navigation/`
...
* [@maykar](https://github.com/maykar) for the original 
